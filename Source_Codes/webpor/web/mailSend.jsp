<%@ page contentType="text/html;charset=utf-8" pageEncoding="utf-8" errorPage="/errFolder/errPagde.jsp" %>
...
<%
    ...
    try{
        String st = "toMan@nate.com";    // 받는 사람

        String sbj = "이메일 테스트 인증번호입니다.";
        String sf = "buram@gmail.com";   // 보내는 사람(인증 정보와 동일한 email 주소여야 함!!)
...
%>
<% out.clear(); %><%=sResult%>
출처: https://godlvkhj.tistory.com/126 [하은양 믿음군 효실맘 호홍홍집s:티스토리]